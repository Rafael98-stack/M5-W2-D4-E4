...
//
//import it.be.epicode.EsercizioQuattro.entities.Blogpost;
//import it.be.epicode.EsercizioQuattro.exceptions.NotFoundException;
//import it.be.epicode.EsercizioQuattro.payloads.NewBlogPostPayload;
//import it.be.epicode.EsercizioQuattro.services.BlogsService;
...
//    public Blogpost saveBlog(@RequestBody epicode.u5d8hw.payloads.NewBlogPostPayload body) {
...
//    @PutMapping("/{blogId}")
//    public Blogpost findAndUpdate(@PathVariable int blogId, @RequestBody epicode.u5d8hw.payloads.NewBlogPostPayload body) {
